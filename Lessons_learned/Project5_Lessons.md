...
- I learned how the **Joiner, Mover, Leaver (JML) lifecycle** works and why it’s important to update access when a user changes roles or leaves.  
- I saw how **group memberships control access** and how moving users between groups reflects real-world role changes.  
